                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-dark text-center p-3">
                                            ...
                                            <p>Veillez-vous inscrire pour accéder au tableau de bord.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-4">
                                    <form method="POST" action="{{ route('admin.register.submit') }}">
                                        ...
                                        <div class="form-group mb-4 text-left position-relative">
                                            ...
                                            <input type="password" class="form-control" name="password_confirmation" id="exampleInputPassword1" placeholder="Mot de passe" required>
                                            <span class="toggle-password" onclick="togglePassword()" style="position:absolute; right:15px; top:38px; cursor:pointer;">
                                            👁️
                                            </span>
                                        </div>
                                        ...
                                        <div class="mt-3 d-grid">
                                            <button class="btn btn-warning waves-effect waves-light" type="submit">INSCRIPTION</button>
                                        </div>
                                    </form>
                                </div>
