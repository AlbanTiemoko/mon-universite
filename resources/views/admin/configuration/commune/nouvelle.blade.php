...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Nouvelle Commune/Quartier</title>
                            ...
                            <!-- start page title -->
                                <div class="col-md-10 mt-4">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0 font-size-18">ENREGISTREMENT COMMUNE/QUARTIER</h4>
                                    </div>
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col mb-4 text-center">
                                                                        <button type="submit" class="btn btn-primary font-weight-bold w-25">ENREGISTRER COMMUNE/QUARTIER</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
