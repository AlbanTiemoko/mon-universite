...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Modification Ville</title>
                            ...
                            <!-- start page title -->
                                <div class="col-md-10 mt-4">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0 font-size-18">MODIFICATION VILLE</h4>
                                    </div>
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="row form-group">
                                                                    <div class="col-md-6 mb-4">
                                                                        ...
                                                                        <input type="text" class="form-control" name="reference_ville" placeholder="V001" value="{{ $villes->reference }}">
                                                                    </div>
                                                                    <div class="col-md-6 mb-4">
                                                                        <label for="formGroupExampleInput">Nom Ville(*)</label>
                                                                        <input type="text" class="form-control" name="nom_ville" placeholder="Abidjan" value="{{ $villes->nom }}">
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
                                                                    <div class="col mb-4 text-center">
                                                                        <button type="submit" class="btn btn-primary font-weight-bold w-25">MODIFIER VILLE</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
