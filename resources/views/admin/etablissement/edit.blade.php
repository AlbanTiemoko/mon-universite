...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Modification Etablissement</title>
                            ...
                            <!-- start page title -->
                                <div class="col-md-10 mt-4">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0 font-size-18">MODIFICATION ETABLISSEMENT</h4>
                                    </div>
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="row form-group">
                                                                    <div class="col mb-4">
                                                                        ...
                                                                        <input type="text" class="form-control" name="reference" required value="{{ $etablissement->reference }}">
                                                                    </div>
                                                                    <div class="col mb-4">
                                                                        <label for="formGroupExampleInput">Non Etablissement(*)</label>
                                                                        <input type="text" class="form-control" name="nom" required value="{{ $etablissement->nom }}">
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
                                                                    <div class="col mb-4">
                                                                        <label for="formGroupExampleInput">Numero Telephone(s)(*)</label>
                                                                        <input type="text" class="form-control" name="numero" required value="{{ $etablissement->numero }}">
                                                                    </div>
                                                                    <div class="col mb-4">
                                                                        <label for="formGroupExampleInput">Deuxime Numero Telephone(*)</label>
                                                                        <input type="text" class="form-control" name="deuxieme_numero" required value="{{ $etablissement->deuxieme_numero }}">
                                                                    </div>
                                                                    <div class="col mb-4">
                                                                        <label for="formGroupExampleInput">Email(*)</label>
                                                                        <input type="text" class="form-control" name="email" required value="{{ $etablissement->email }}">
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
                                                                    <div class="col mb-4">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col mb-4">
                                                                        ...
                                                                        <input type="text" class="form-control" name="longitude" required value="{{ $etablissement->longitude }}">
                                                                    </div>
                                                                    <div class="col mb-4">
                                                                        <label for="formGroupExampleInput">Lagitude(*)</label>
                                                                        <input type="text" class="form-control" name="latitude" required value="{{ $etablissement->latitude }}">
                                                                    </div>
                                                                </div>
                                                                @foreach($etablissement->adresses as $adresse)
                                                                    <div class="location-row row mb-3">
                                                                        <div class="col">
                                                                            <label>Ville</label>
                                                                            <select name="ville_id[]" class="form-control" required>
                                                                                @foreach($villes as $ville)
                                                                                    <option value="{{ $ville->id }}" {{ $adresse->ville_id == $ville->id ? 'selected' : '' }}>{{ $ville->nom }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                        <div class="col">
                                                                            ...
                                                                            <select name="commune_id[]" class="form-control">
                                                                                ...
                                                                                @foreach($communes as $commune)
                                                                                    <option value="{{ $commune->id }}" {{ $adresse->commune_id == $commune->id ? 'selected' : '' }}>{{ $commune->nom }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                        <div class="col">
                                                                            <label>Rue</label>
                                                                            <input type="text" name="rue[]" value="{{ $adresse->rue }}" class="form-control" required>
                                                                        </div>
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col my-4">
                                                                        ...
                                                                        <input type="website" class="form-control" name="url_spot" required value="{{ $etablissement->url_spot }}">
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
                                                                    <div class="col mb-4">
                                                                        <label for="formGroupExampleInput">Description Etablissement(*)</label>
                                                                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="10">{{ $etablissement->description }}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
