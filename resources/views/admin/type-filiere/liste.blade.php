...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Liste Type Filiers</title>
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title mb-4">
                                                <div class="col mb-4 text-right">
                                                    <a href="{{ route('type.filiere.nouveau') }}">
                                                        <button type="submit" class="btn btn-primary font-weight-bold">NOUVEAU TYPE FILIERE</button>
                                                    </a>
                                                </div>
                                            </h4>
                                                ...
                                                <table class="table align-middle table-nowrap mb-0">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="align-middle">Nom Type Filiere </th>
