...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Nouveau Administrateur</title>
                            ...
                            <!-- start page title -->
                                <div class="col-md-10 mt-4">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0 font-size-18">ENREGISTREMENT ADMINISTRATEUR</h4>
                                    </div>
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1">
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="col-md-6 mb-4">
                                                                        <label for="formGroupExampleInput">Prenom(s)(*)</label>
                                                                        <input type="text" class="form-control" required>
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col mb-4 text-center">
                                                                        <button type="submit" class="btn btn-primary font-weight-bold w-25">ENREGISTRER ADMINISTRATEUR</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
