...
<html lang="fr">
  <head>
    <title>Comment trouver votre future etablissement - Trouver Mon Ecole</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/assets/css/article_lu.css">
      ...
      <div class="container mb-4">
        <div class="row">
            <div class="col text-center font-weight-bold py-5">
                <a href="index.html" class="text_header">Accueil</a><span> / </span> <a href="{{ route('blog') }}" class="text_header">Informations actuelle</a><span> / </span>Actualités
            </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="container">
          <div class="row">
            <div class="col">
                ...
                <div class="row mb-4">
                    <div class="col">
                        <img src="{{ asset($article->image) }}" class="d-block w-100" class="d-block w-100" alt="">
                    </div>
                </div>
                <div class="row mb-2">
                ...
                <div class="row mb-4">
                    <div class="col text-center">
                        <a href="{{ route('blog') }}" class="btn btn-success font-weight-bold">TOUS LES ARTCILES</a>
                    </div>
                </div>
