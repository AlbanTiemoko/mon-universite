<div class="col-md-2 bg-info text-dark pl-4 pt-4">
    <div class="">
        ...
        <a href="{{ route('dashboard') }}" class="link"><p class="font-weight-bold h6"><i class="bx bx-home-circle pr-2 pb-3"></i> Tableau de bord</p></a>
        <a href="#" class="link"><h6></h6></a>

        <a href="#" class="link"><p class="font-weight-bold h6"><i class="bx bx-layout pr-2 pb-1"></i> Etablissements</p></a>
