        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col text-center my-4 font-weight-bold">
                    <a href="{{ route('accueil') }}" class="home">Accueil</a> <span>/ Formations Qualifiantes</span>
                </div>
            </div>
            @foreach($formation->chunk(10) as $group)
                <div class="row mb-5">
                    @foreach($group as $filiere)
                        <div class="col">
                            <a href="{{ route('formations', ['filiere' => $filiere->id]) }}"
