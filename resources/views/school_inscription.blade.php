...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="school_inscription.css">
      ...
      <div class="container mb-4">
        <div class="row">
            <div class="col text-center font-weight-bold py-5">
                <a href="index.html" class="text_header">Accueil</a><span> / </span><a href="filieres.html" class="text_header">Filières & Universités </a><span>/ Inscription</span>
            </div>
        </div>
        <div class="row my-3">
